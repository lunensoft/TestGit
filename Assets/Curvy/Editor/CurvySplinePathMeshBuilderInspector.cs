...
public class CurvySplinePathMeshBuilderInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(tSpline, new GUIContent("Spline","Spline to render"));
        ...
        GUILayout.Label("Last Refresh (ms): " + string.Format("{0:0.0000}",Target.DebugPerfTime));
